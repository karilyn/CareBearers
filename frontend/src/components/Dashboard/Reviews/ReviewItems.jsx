        ...
        return (
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">{getCaregiverDetails(caregivers, res.caregiver_id) ? getCaregiverDetails(caregivers, res.caregiver_id).first_name : null } watched your kids from {moment(res.start_time).format("h:mm a")} - {moment(res.end_time).format("h:mm a")}</p>
